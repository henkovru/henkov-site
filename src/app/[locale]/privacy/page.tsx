...
export default function PrivacyPolicy() {
  ...
  return (
    <div>
      <h2 className="text-4xl text-center mb-8 sm:text-2xl">
        Политика конфиденциальности
      </h2>
      <div className="px-10 text-base mb-8 leading-tight sm:text-sm sm:px-5">
        <p>
          ...
          безопасности персональных данных, предпринимаемые ИП Трушенков Егор
          ...
          сети интернет по сетевому адресу https://henkov.ru.
          <br />
          ...
          <br />
          2.15 На сайте используется Яндекс.Метрика для сбора информации о ее
          пользователях. Находясь на сайте https://henkov.ru он даёт
          согласие о отслеживание данных о его посещаемости с помощью
          Яндекс.Метрики.
          <br />
          ...
          info@henkov.ru с пометкой «Актуализация персональных данных».
          <br />
          ...
          info@henkov.ru с пометкой «Отзыв согласия на обработку
          персональных данных».
          <br />
          ...
          Оператору с помощью электронной почты info@henkov.ru.
          <br />
          ...
          сети Интернет по адресу https://henkov.ru/{localActive}
          /privacy.
        </p>
      </div>
